...
# my_list_comp = [(num,num,num) if num < 20 else 0 for num in range (0,101)]

# inventory_names = ['Screws', 'Wheels', 'Metal Parts', 'Rubber Bits', 'Screwdrivers', 'Wood']
# inventory_numbers = [ 43, 12, 95, 421, 23, 43]
# replinish_list = [(name,number) for name, number in zip(inventory_names, inventory_numbers) if number < 25]

# print(replinish_list)
